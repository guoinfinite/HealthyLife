package com.example.healthylife.application;
...
import com.example.healthylife.utils.BringData;
...
public class DemoApplication extends Application {
    ...
    public void onCreate() {
        ...
        Log.d("数据库数否被存入", "onCreate: " + SaveKeyValues.getStringValues("district", "北京"));
